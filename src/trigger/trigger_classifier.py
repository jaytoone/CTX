...
SYMBOL_PATTERNS = [
    ...
    # Long PascalCase identifier after explicit keyword: "class Environment" (≥8 chars)
    # Short PascalCase (View, Request, Response) stays SEMANTIC — BM25 handles these better
    # on large codebases where they're ubiquitous. Only long, distinctive names route to EXPLICIT.
    re.compile(r'\b(?:function|method|class)\s+([A-Z][a-zA-Z0-9]{7,})\b'),
]
